...
func TestIsProcessRunning(t *testing.T) {
	t.Run(
		"current process", func(t *testing.T) {
	...
	t.Run(
		"terminated process", func(t *testing.T) {
	...
	t.Run(
		"boundary values", func(t *testing.T) {
	...
	t.Run(
		"find process error", func(t *testing.T) {
