...
const zhCN = {
  ...
  init: {
    ...
    model: {
      ...
      reinstalling: '正在刷新路由模板并检查 wrapper 版本...',
      reinstallDone: '路由模板已刷新，wrapper 版本已确认',
      reinstallFailed: '路由模板或 wrapper 更新失败',
    },
    perf: {
      title: '性能模式',
      selectMode: '选择性能模式',
...
const en: typeof zhCN = {
  ...
  init: {
    ...
    model: {
      ...
      reinstalling: 'Refreshing routing templates and checking the wrapper version...',
      reinstallDone: 'Routing templates refreshed and wrapper version confirmed',
      reinstallFailed: 'Routing template or wrapper update failed',
    },
    perf: {
